...
public class ForgetPassActivity extends AppCompatActivity {
    ...
    private void setEvent() {
        ...
        //button Next -> chuyển sang màn hình nhập otp
        btnNext.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
//                if (checkEmailForgetPass(edtEmail.getText().toString())){
//                    Mail.sendEmailNewPass(edtEmail.getText().toString());
//
//                    Log.d("resetPass","successfully");
//                }else{
